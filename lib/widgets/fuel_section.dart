...
class FuelSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final barColor = pct < 15 ? BydColors.error : BydColors.warning;
      ...
      child: Column(
        ...
        children: [
          ...
          if (v.isLowFuelWarning == true) ...[
            ...
            const Row(
              children: [
                Icon(Icons.warning_amber, color: BydColors.error, size: 16),
                Gap(6),
                Text(
                  'Low fuel warning',
                  style: TextStyle(color: BydColors.error, fontSize: 13),
                ),
              ],
            ),
          ],
