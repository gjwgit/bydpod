...
import 'package:bydpod/widgets/door_tile.dart';
    ...
    return DashboardCard(
      child: Column(
        children: [
          ...
          // The Sealion 7 has a fixed panoramic roof on some trims, so the
          // sunroof tile only appears when the car actually reports one.
          if (v.isSunroofOpen != null) ...[
            const Gap(8),
            Row(
              children: [
                Expanded(
                  child: DoorTile('Sunroof', v.isSunroofOpen, isWindow: true),
                ),
                const Gap(8),
