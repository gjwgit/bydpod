    ...
    return Container(
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [BydColors.primary, Color(0xFFB5714A)],
        ...
        children: [
          Row(
            children: [
              ...
              MarkdownTooltip(
                message: '**Fuel Type**\n\n'
                    'The vehicle\'s powertrain type as reported by BYD Connect.\n\n'
            ...
            children: [
              ...
              MarkdownTooltip(
                message: '**Accessory Mode**\n\n'
                    ...
                    'On the Sealion 7 this occurs when you press the Start button '
