...
import 'package:bydpod/widgets/kv_table.dart';
import 'package:bydpod/widgets/primitives.dart';
import 'package:bydpod/widgets/tyre_tile.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          if (v.interiorTempC != null) ...[
            ...
            KVRow(
              'Cabin Temperature',
              '${v.interiorTempC!.toStringAsFixed(1)}°C',
            ),
          ],
...
class InfoSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final rows = <MapEntry<String, String>>[
      ...
      if (v.plate.isNotEmpty) MapEntry('Plate', v.plate),
      if (v.speedKmh != null)
        MapEntry('Speed', '${v.speedKmh!.toStringAsFixed(0)} km/h'),
      if (v.isOnline != null)
        MapEntry('Connectivity', v.isOnline! ? 'Online' : 'Offline'),
