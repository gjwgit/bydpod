    ...
    return Container(
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [BydColors.primary, Color(0xFF7A5C44)],
        ...
        boxShadow: [
          BoxShadow(
            color: BydColors.primary.withValues(alpha: 0.35),
            blurRadius: 20,
              ...
              if (v.batteryCapacityKwh != null)
                _HeroChip(
                  ...
                  tooltip: '**Battery Capacity**\n\n'
                      ...
                      'The Sealion 7 carries an 82.6 kWh Blade (LFP) pack.\n\n'
                      '*Note: BYD does not publish pack capacity through the '
                      'API, so this is only shown when a snapshot carries it.*',
                ),
              if (v.batteryRemainKwh != null)
                _HeroChip(
                  ...
                  tooltip: '**Energy Remaining**\n\n'
                      ...
                      'For example, 58% of an 82.6 kWh battery '
              ...
              if (v.batterySohPercent != null)
                _HeroChip(
                  ...
                  tooltip: '**State of Health (SoH)**\n\n'
                      ...
                      'A 90% SoH on an 82.6 kWh battery means it now holds ~74.3 kWh.',
                ),
