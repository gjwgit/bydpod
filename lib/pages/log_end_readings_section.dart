...
/// Fetch from BYD Connect button.

class LogEndReadingsSection extends StatelessWidget {
  final ColorScheme cs;

  /// Whether a BYD Connect fetch is in flight — shows a spinner in place of the
  /// icon and disables the button.
  final bool fetching;

  /// Fetch the end readings from BYD Connect. Null when not logged in to
  /// BYD Connect, in which case the button is not offered at all.
            ...
            children: [
              ...
              if (onFetch != null)
                TextButton.icon(
                  ...
                  label: const Text('From BYD Connect'),
