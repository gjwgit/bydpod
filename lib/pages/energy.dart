...
import 'package:bydpod/screens/battery_efficiency_bar.dart';
import 'package:bydpod/screens/battery_kwh_plot.dart';
import 'package:bydpod/screens/battery_observation_table.dart';
import 'package:bydpod/screens/battery_scatter_plot.dart';
import 'package:bydpod/services/app_provider.dart';
import 'package:bydpod/services/battery_observation_service.dart';
import 'package:bydpod/widgets/section_label.dart';
          ...
          if (v.isEV) ...[
            ...
            const SectionLabel(
              ...
              tooltip: '**Battery Observations**\n\n'
                  ...
                  'BYD Connect or loaded from your Pod.\n\n'
  ...
  Widget build(BuildContext context) {
    ...
    if (obs.isEmpty) {
      return Padding(
        ...
        child: Center(
          child: Text(
            'No battery observations yet.\nRefresh BYD Connect data to start collecting.',
            textAlign: TextAlign.center,
            style: TextStyle(
              color: Theme.of(context).colorScheme.onSurfaceVariant,
            ),
