...
import 'package:bydpod/widgets/labeled_value_field.dart';
...
class LogChargeSection extends StatefulWidget {
  ...
  /// the end vehicle readings + Fetch from BYD Connect button.
...
class LogChargeSectionState extends State<LogChargeSection> {
  ...
  /// Populate derived fields calculated from BYD Connect end-of-charge data.

  void populateFromByd({
