      ...
      children: [
        if (lastUpdated != null)
          _TsLine(
            ...
            tooltip: '**Last Updated**\n\n'
                ...
                'BYD Connect servers. The car transmits periodically '
        ...
        if (fetchedAt != null)
          _TsLine(
            ...
            cs,
            tooltip: '**Fetched At**\n\n'
                'When this app retrieved the data from the BYD API. '
        ...
        if (registrationDate != null)
          _TsLine(
            ...
            tooltip: '**Collected Since**\n\n'
                ...
                'the BYD Connect service — typically the delivery date.',
          ),
      ],
    );
  }
