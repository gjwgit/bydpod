...
import 'package:bydpod/pages/log_charge_section.dart';
import 'package:bydpod/pages/log_end_readings_section.dart';
import 'package:bydpod/pages/log_entry_widgets.dart';
import 'package:bydpod/pages/log_location_section.dart';
import 'package:bydpod/pages/log_timestamp_field.dart';
...
class _LogEntryEditState extends State<LogEntryEdit> with UnsavedChangesMixin {
  ...
  /// Refresh from BYD Connect and populate end readings with current vehicle state.
  Future<void> _fetchEndReadings() async {
    ...
    try {
      ...
      _chargeKey.currentState?.populateFromByd(
