...
import 'package:bydpod/utils/pod_utils.dart';
...
class PodService {
  ...
  static const _prefixes = '@prefix bydpod: <https://'
      'bydpod.solidcommunity.au/ont/> .\n'
      '@prefix xsd:     <http://'
      'www.w3.org/2001/XMLSchema#> .\n';

  /// Wraps a JSON string in a Turtle document as a plain string literal.
  /// The predicate is a bydpod: term so the file is self-describing.
  ...
  static Future<String?> deleteStatusFile(String filename) async {
    try {
      await deleteFile(fileUrl: await getFileUrl('bydpod/data/$filename'));
