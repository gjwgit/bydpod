/// BackupService — export and restore all bydpod Pod data as JSON.
///
/// A backup is a single JSON document containing the raw (decrypted) Turtle
/// content of every bydpod data file on the Pod. Restoring writes each file
...
class BackupService {
  ...
  static Future<RestoreResult> importAll(String jsonStr) async {
    ...
    if (backup['app'] != 'bydpod') {
      return const RestoreResult(
        error: 'This file is not a bydpod backup.',
      );
    }
