...
import 'package:bydpod/screens/history_export.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: const TextStyle(color: BydColors.error),
            ),
            const Gap(16),
            ElevatedButton.icon(
              onPressed: _loadList,
      ...
      body = Center(
        child: Column(
          ...
          children: [
            ...
            const Gap(8),
            Text(
              'Log in to BYD Connect and tap Save to Pod to create a snapshot.',
              textAlign: TextAlign.center,
              style: TextStyle(
        ...
        itemBuilder: (_, i) {
          ...
          final tile = ListTile(
            leading: isDeleting
                ...
                : Icon(
                    ...
                    color: isLoaded ? BydColors.accent : null,
                  ),
            title: Text(
              _formatTitle(f),
                ...
                : Row(
                    ...
                    children: [
                      if (isLoaded)
                        const Chip(
                          label: Text('Active'),
                          backgroundColor: BydColors.accent,
                          labelStyle:
          ...
          return Card(
            ...
            shape: RoundedRectangleBorder(
              ...
              side: isLoaded
                  ? const BorderSide(color: BydColors.accent, width: 2)
                  : BorderSide.none,
            ),
            child: tile,
          );
