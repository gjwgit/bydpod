/// History import/export helpers for BydPod.
///
...
class HistoryExport {
  ...
  static Future<void> exportJson(
    ...
    try {
      ...
      final fileName = 'bydpod_history_$stamp.json';
  ...
  static Future<void> exportPdf(
    ...
    try {
      ...
      final fileName = 'bydpod_history_$stamp.pdf';
