...
import 'package:bydpod/screens/login_screen.dart';
import 'package:bydpod/services/app_provider.dart';
import 'package:bydpod/theme/byd_theme.dart';
import 'package:bydpod/widgets/doors_section.dart';
import 'package:bydpod/widgets/hero_card.dart';
import 'package:bydpod/widgets/sections_comfort.dart';
import 'package:bydpod/widgets/sections_energy.dart';
import 'package:bydpod/widgets/stat_card.dart';
import 'package:bydpod/widgets/warnings_section.dart';
import 'package:bydpod/widgets/windows_section.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<AppProvider>(
      builder: (context, provider, _) {
        ...
        return Scaffold(
          backgroundColor: BydColors.scaffoldBg,
          appBar: _buildAppBar(context, provider, v),
          body: v == null
              ? const Center(child: CircularProgressIndicator())
              : RefreshIndicator(
                  onRefresh: provider.refresh,
                  color: BydColors.primary,
