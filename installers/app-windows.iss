...
#define MyAppName "BydPod"
#define MyAppVersion "windows-inno"
#define MyAppPublisher "Togaware Pty Ltd"
#define MyAppURL "https://github.com/gjwgit/bydpod
#define MyAppExeName "bydpod.exe"
...
OutputBaseFilename=bydpod-{#MyAppVersion}
...
; directory, so it must be installed beside the binary.
Source: "..\byd_fetch.py"; DestDir: "{app}"; Flags: ignoreversion
