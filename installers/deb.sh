...
Description: Collect and save your BYD Sealion 7 data
...
[Desktop Entry]
Name=${APP}
Comment=Sealion 7 app with data stored securely and privately.
Exec=/usr/bin/${APP}
Icon=${APP}
Terminal=false
Type=Application
...
# Ship the BYD helper script beside the binary. BydService looks for it in
# the executable's own directory, so without this every install reports
# "byd_fetch.py not found" and no live data can be fetched.

cp ../byd_fetch.py ${APP}_${VER}_amd64/usr/lib/${APP}/
