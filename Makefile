...
# Generic Makefile
#
# Time-stamp: <Monday 2026-08-31 11:11:01 +1000 Graham Williams>
#
...
ZFILES := lib test integration_test pubspec.yaml analysis_options.yaml README.md CLAUDE.md byd_fetch.py

# The Dart suite covers the app; the Python suite covers byd_fetch.py's
# mapping of the BYD API onto the fields the app consumes. Both run without
# a Pod and without a BYD account.

.PHONY: tests
tests::
	flutter analyze
	flutter test
	python3 test/byd_fetch_test.py
